...
{{-- affichage post sur profil user --}}
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('post.store') }}">
            ...
            @foreach ($post as $post) <!--normalement, c'est $posts as $post, si la boucle ne fonctionne pas revenir au commit du 11 au midi -->
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <!--création de route pour updating -->
